...
const parts = [
  { num: 1, range: 'Q1–Q32', href: `${BASE}/lec2/1` },
  { num: 2, range: 'Q33–Q64', href: `${BASE}/lec2/2` },
  { num: 3, range: 'Q65–Q65', href: `${BASE}/lec2/3` },
]
export default function Lec2Index() {
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: 'system-ui,sans-serif' }}>
      <h1 style={{ color: '#f1f5f9', fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem' }}>Lecture 2: Linear Algebra</h1>
      <p style={{ color: '#64748b', fontSize: '0.8rem', fontFamily: 'monospace', marginBottom: '2rem' }}>lectures/cg-02-lecture-quiz.md · 65 questions</p>
