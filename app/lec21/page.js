...
const parts = [
  { num: 1, range: 'Q1–Q32', href: `${BASE}/lec21/1` },
  { num: 2, range: 'Q33–Q36', href: `${BASE}/lec21/2` },
]
export default function Lec21Index() {
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: 'system-ui,sans-serif' }}>
      <h1 style={{ color: '#f1f5f9', fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem' }}>Lecture 21: Dynamics & Time Integration</h1>
      <p style={{ color: '#64748b', fontSize: '0.8rem', fontFamily: 'monospace', marginBottom: '2rem' }}>lectures/cg-21-lecture-quiz.md · 36 questions</p>
