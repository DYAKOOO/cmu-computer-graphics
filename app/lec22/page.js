...
const parts = [
  { num: 1, range: 'QF1–Q29', href: `${BASE}/lec22/1` },
  { num: 2, range: 'Q30–Q61', href: `${BASE}/lec22/2` },
  { num: 3, range: 'Q62', href: `${BASE}/lec22/3` },
]
export default function Lec22Index() {
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <p style={{ color: '#64748b', fontSize: '0.8rem', fontFamily: 'monospace', marginBottom: '2rem' }}>lectures/cg-22-lecture-quiz.md · 65 questions · 3 parts</p>
