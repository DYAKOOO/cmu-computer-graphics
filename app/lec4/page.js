...
const parts = [
  { num: 1, range: 'QF1–Q29', href: `${BASE}/lec4/1` },
  { num: 2, range: 'Q30–Q61', href: `${BASE}/lec4/2` },
  { num: 3, range: 'Q62–Q64', href: `${BASE}/lec4/3` },
]
export default function Lec4Index() {
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: 'system-ui,sans-serif' }}>
      <h1 style={{ color: '#f1f5f9', fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem' }}>Lecture 4: Rasterization & Sampling</h1>
      <p style={{ color: '#64748b', fontSize: '0.8rem', fontFamily: 'monospace', marginBottom: '2rem' }}>lectures/cg-04-lecture-quiz.md · 67 questions · 3 parts</p>
