...
export default function Lec7Index() {
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <a href={`${BASE}/lec7/2`} style={{ display: 'block', background: '#1e293b', border: `2px solid ${ACCENT}`, borderRadius: '10px', padding: '1.25rem 2rem', textDecoration: 'none', textAlign: 'center' }}
        onMouseEnter={e => e.currentTarget.style.opacity = '0.85'}
        onMouseLeave={e => e.currentTarget.style.opacity = '1'}>
        <div style={{ color: ACCENT, fontWeight: 700 }}>Part 2</div>
      </a>
      <a href={`${BASE}/lec7/3`} style={{ display: 'block', background: '#1e293b', border: `2px solid ${ACCENT}`, borderRadius: '10px', padding: '1.25rem 2rem', textDecoration: 'none', textAlign: 'center' }}
        onMouseEnter={e => e.currentTarget.style.opacity = '0.85'}
        onMouseLeave={e => e.currentTarget.style.opacity = '1'}>
