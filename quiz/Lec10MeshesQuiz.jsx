...
import { ChevronLeft, ChevronRight, RefreshCw, BookOpen, Trophy, Clock, CheckCircle, XCircle, Box } from 'lucide-react'

// Source: lectures/cg-10-lecture-quiz.md  (symlinked → Logseq pages)
// Lecture 10: Meshes & Manifolds · Q1–Q27 · 27 questions
...
const quizData = [
  {
    ...
    options: [`Rasterization pipeline implementation`, `Different types of geometry in nature`, `Array-based data structures`, `Mesh subdivision algorithms`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Manifold and non-manifold geometry`, `Polygon meshes and subdivision surfaces`, `Implicit and explicit representations`, `Sparse and dense representations`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`It must be composed of triangles`, `It must have no boundaries`, `You can zoom in and draw a nice coordinate grid with two distinct directions`, `It must be representable as a halfedge data structure`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`"Loops, not links"`, `"Circles, not stars"`, `"Fans, not fins"`, `"Edges, not vertices"`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Every vertex must be connected to exactly three edges`, `Every face must be a triangle`, `Every edge must be contained in only two polygons`, `Every vertex must be contained in at most one face`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Every face must be convex`, `Every vertex must be contained in a single fan or loop of polygons`, `Every edge must connect exactly two vertices`, `The mesh must be orientable`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Where the surface has holes`, `Where the surface ends`, `Where two surfaces intersect`, `Where the normal vector changes direction`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`They always form a single closed loop`, `They always have sharp corners`, `They must be composed of straight line segments`, `They can never intersect themselves`],
    answer: 0,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Because manifold meshes render faster`, `Because it makes data structures and algorithms simpler and more efficient`, `Because manifold geometry is easier to animate`, `Because manifold shapes are more aesthetically pleasing`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Trees and graphs`, `Arrays and linked lists`, `Stacks and queues`, `Hash tables and dictionaries`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`A rendering algorithm for smooth surfaces`, `A mixture of different polygon types in one mesh`, `The simplest representation where each triangle's three vertex coordinates are stored independently`, `A technique for simplifying complex meshes`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`It supports non-manifold meshes`, `It splits the geometry (vertices) from the connectivity (indices)`, `It requires less memory`, `It supports animation`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`O(1) - constant time`, `O(log n) - logarithmic time`, `O(n) - linear time with the number of polygons`, `O(n²) - quadratic time`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Mathematical tools for calculating surface curvature`, `Tables representing which mesh elements are connected to which other elements`, `Probability distributions of element connections`, `Matrices that transform mesh vertices into screen space`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`They don't support non-manifold meshes`, `They are too slow for rendering`, `They would require storing huge matrices with mostly zeros`, `They require specialized hardware`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Storing rows as continuous blocks of memory`, `For each row, storing a list of non-zero entries with their column indices and values`, `Compressing each row using a hash function`, `Using a binary tree to represent each row`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`It uses less memory than any other format`, `It's the easiest format to implement`, `It's really fast for actual matrix math operations`, `It supports parallel processing`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Storing only half of the mesh data to save memory`, `Splitting each edge into two directed halfedges pointing in opposite directions`, `Using arrays to store mesh elements for faster access`, `Maintaining exact half of the vertices as control points`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Only its vertices and the face it belongs to`, `Its twin, the next halfedge, its source vertex, its edge, and its face`, `A list of all vertices in the mesh`, `Only its twin halfedge`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Use a breadth-first search starting from any vertex`, `Look up the vertex indices in an adjacency list`, `Start with the face's halfedge and keep following the next pointer until you return to the start`, `Use a vertex-face incidence matrix`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Halfedge data structures can only represent a subset of manifold meshes`, `Manifold meshes require more complex data structures than halfedge`, `If a mesh has valid halfedge connectivity, it will always describe a manifold polygon mesh`, `Halfedge structures can efficiently represent both manifold and non-manifold meshes`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Connectivity is about the number of vertices while geometry is about the number of faces`, `Connectivity relates to how mesh elements are connected while geometry relates to vertex positions`, `Connectivity is only relevant for manifold meshes while geometry applies to all meshes`, `Connectivity is a 2D property while geometry is 3D`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Because they use less memory than other representations`, `Because they render faster`, `Because they're like linked lists, making it easy to insert and delete elements`, `Because they enforce non-manifold connections`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`It reverses the direction of all halfedges`, `It changes the coordinates of the mesh vertices`, `It replaces two triangles sharing an edge with two different triangles connecting the opposite vertices`, `It connects all unpaired boundary edges`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Edge split requires creating new elements while edge flip just reassigns pointers`, `Edge split only works on boundary edges while edge flip works on interior edges`, `Edge split always creates triangular faces while edge flip can create any polygon`, `Edge split is irreversible while edge flip is reversible`],
    answer: 0,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Both require specialized hardware for efficient computation`, `Both deal with continuous functions that need to be sampled`, `Digital geometry processing generalizes traditional digital signal processing`, `Signal processing is being replaced by geometry processing`],
    answer: 2,
    intuition: ``,
          ...
          <div style={{ background: '#0d0d12', padding: '1.5rem', borderRadius: '12px', marginBottom: '1.5rem', border: `1px solid ${C.border}` }}>
            ...
            {expTab === 'intuition' && (
              q.intuition
                ...
                : <p style={{ color: '#475569', margin: 0, fontSize: '0.875rem' }}>No intuition written yet. Add a <code style={{ color: C.accent }}>- INTUITION:</code> block under this question in <code style={{ color: C.accent }}>lectures/cg-10-lecture-quiz.md</code>.</p>
            )}
            {expTab === 'explanation' && (
              q.explanation
