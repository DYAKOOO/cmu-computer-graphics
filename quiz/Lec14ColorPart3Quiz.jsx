...
// Lecture 14: Color — Part 3 · QQ62–QQ66 · 5 questions (5 MCQ, 0 reveal)
...
const quizData = [
  ...
  },
  {
    ...
    format: `mcq`,
    timestamp: `1:18:50`,
    question: `In the afterimage experiment with the inverted American flag, what principles of human visual perception are being demonstrated?`,
    options: [`How retinal fatigue causes temporary blindness`, `How memory affects color perception`, `Color blindness effects and limitations`, `Neural adaptation and the fact that neurons respond to changes in color rather than absolute values`],
    answer: 3,
    answerText: ``,
    intuition: ``,
    explanation: `At [1:18:06], the lecturer explains: "Your neurons are not things that just measure of value they're things that actually respond to change so the cones in your eye for instance are not actually measuring the intensity of color they're measuring the change in color over time." The experiment demonstrates this adaptation.`,
    code: ``,
    images: ["lec14_slide_65.png"],
    tags: [],
    source: `lectures/cg-14-lecture-quiz.md.md`,
  },
  {
    ...
    format: `mcq`,
    timestamp: `1:20:18`,
    question: `What topics does the lecturer preview for upcoming lectures?`,
    options: [`Radiometry, light interaction with cameras and materials, building toward photorealistic rendering`, `Color psychology and marketing`, `The history of color theory and famous artists`, `Medical applications of color science`],
    answer: 0,
    answerText: ``,
    intuition: ``,
    explanation: `At [1:20:32], the lecturer states: "In the next few lectures we'll talk more about radiometry how do we quantify different amounts of light and then we'll talk a bit about how that light interacts with cameras with materials scattering and so forth basically building up toward photorealistic rendering."`,
    code: ``,
    images: ["lec14_slide_65.png"],
    tags: [],
    source: `lectures/cg-14-lecture-quiz.md.md`,
...
export default function Lec14Part3Quiz() {
    ...
    <div style={base}>
      <div style={box}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '2.2rem', fontWeight: 700, color: C.accent, margin: '0 0 0.5rem' }}>Lecture 14: Color — Part 3</h1>
          ...
          <a key={3} href={`${BASE}/lec14/3`} style={{ color: C.accent, fontSize: "0.85rem" }}>Part 3</a>
          </div>
          <p style={{ color: C.accent, fontWeight: 600 }}>QQ62–QQ66 · 5 questions (5 graded + 0 open)</p>
        </div>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{ color: C.accent, fontWeight: 600 }}>Lecture 14: Color — Part 3</span>
            </div>
