...
// Lecture 22: Introduction to Optimization — Part 1 · Q1–Q32 · 32 questions
...
const quizData = [
  {
    ...
    options: [`Both topics involve rendering algorithms`, `Both involve solving systems of linear equations`, `Both involve numerical approaches to animation`, `Both involve hardware acceleration techniques`],
    answer: 2,
    intuition: ``,
...
"From f=ma , we can get complexity"`,
  ...
  },
  {
    ...
    options: [`Finding any possible solution to a set of equations`, `Finding the most efficient algorithm for a given task`, `Finding the best possible solution among all possibilities, possibly subject to constraints`, `Finding a way to approximate an otherwise intractable problem`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`A square shape`, `A triangular shape`, `A circular shape`, `An elliptical shape`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    code: ``,
    images: ["image_1777602081641_0.png", "lec22_slide_04.png"],
    tags: ["Robotics"],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`Texture quality`, `Rendering speed`, `Symmetry`, `Vertex count`],
    answer: 2,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777602143106_0.png", "lec22_slide_05.png"],
    tags: ["Symmetry"],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`When the objective function is discontinuous`, `When the domain is a discrete set (finite or countable)`, `When the constraints are discrete`, `When only integer solutions are acceptable`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Finding the shortest path between cities`, `Determining the best vegetable for a stew`, `Minimizing the cost of a manufacturing process`, `Finding the optimal number of processors`],
    answer: 1,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777602389117_0.png", "lec22_slide_08.png"],
    tags: [],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`Shortest path`, `Maximum flow`, `Minimum spanning tree`, `Maximum clique`],
    answer: 2,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777603072991_0.png", "lec22_slide_08.png"],
    tags: [],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`Linear programming`, `Convex quadratic programming`, `Traveling Salesman Problem`, `Minimum spanning tree`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`The variables can only take discrete values`, `The variables can take any real value within the domain`, `The objective function must be differentiable`, `The constraints must be linear`],
    answer: 1,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777603100893_0.png", "lec22_slide_08.png"],
    tags: ["definition"],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`Finding the best three vegetables for a stew`, `Finding the best temperature to cook an egg`, `Finding the shortest route through cities`, `Finding the cheapest flight`],
    answer: 1,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777603151969_0.png", "lec22_slide_08.png"],
  ...
  },
  {
    ...
    options: [`All linear programming problems`, `All quadratic programming problems`, `All convex optimization problems`, `All NP-hard problems`],
    answer: 2,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777603202379_0.png", "lec22_slide_08.png"],
  ...
  },
  {
    ...
    options: [`Maximize a function subject to equality constraints`, `Minimize a function subject to inequality constraints`, `Find the roots of a function subject to boundary conditions`, `Solve a system of equations with unknown variables`],
    answer: 1,
    intuition: ``,
...
you have a function that you need a minimize (satisfy) and that it has to satisfy the constraints as well, it means the minimized function has to been less the constraint.`,
  ...
  },
  {
    ...
    options: [`The physical energy of the system`, `The computational cost of solving the problem`, `How "bad" the solution is or how much it costs`, `The time required to reach the solution`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`By taking the reciprocal of the objective function`, `By flipping the sign of the objective function`, `By using the dual of the problem`, `By applying the KKT conditions`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`By replacing each equality with a quadratic inequality`, `By using the KKT conditions`, `By introducing complementary constraints (≤ c and ≤ -c)`, `By introducing slack variables`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`They reject the problem and ask for reformulation`, `They transform the problem into standard form and hand it to a solver`, `They solve each constraint separately`, `They use machine learning to determine the best approach`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Global minima are always unique while local minima can be multiple`, `Global minima are always harder to compute than local minima`, `A global minimum is the absolute best among all possibilities, while a local minimum is the best among immediate neighbors`, `Global minima require constraints while local minima don't`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`When computation time is limited`, `When the global minimum is difficult to find`, `When the local minimum has better physical meaning for the system`, `When working with convex functions`],
    answer: 2,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777603665568_0.png", "lec22_slide_10.png"],
    tags: ["Concept"],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`Designing machine learning models`, `Plotting a path through a city that gets caught on obstacles`, `Protein folding simulations`, `Numerical weather prediction`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    code: ``,
    images: ["image_1777603817734_0.png", "lec22_slide_11.png"],
    tags: ["Visualization"],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`A line`, `A parabola`, `A unit disk`, `An ellipse`],
    answer: 2,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777603839672_0.png", "lec22_slide_11.png"],
    tags: [],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`Global minima can sometimes be saddle points`, `Global minima can be non-unique (multiple points with same minimum value)`, `Global minima always occur at boundary points`, `Global minima only exist for convex functions`],
    answer: 1,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777603885743_0.png", "lec22_slide_11.png"],
    tags: [],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`Minimize e^x`, `Minimize x`, `Minimize 1/x`, `Minimize log(x)`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Because the function is not differentiable`, `Because the function is not bounded from below`, `Because the constraints are not feasible`, `Because the domain is not compact`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Finding the point closest to the origin`, `Finding the global minimum`, `Finding any point that satisfies all the constraints`, `Finding the maximum entropy solution`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Minimizing x² + y² subject to x = 1 and x = 2`, `Minimizing 0 subject to x = 1 and x = -1`, `Maximizing x subject to x ≤ 0`, `Minimizing e^(-x) over all real numbers`],
    answer: 1,
    intuition: ``,
...
"I hope you remember that you can't always solve ax=b , if the matrix is not full rank."`,
    code: ``,
    images: ["image_1777604435276_0.png", "lec22_slide_14.png"],
    tags: [],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`The objective function was unbounded`, `The constraints were contradictory`, `The two constraint regions had no common points (no overlap)`, `The objective function had no minimum on the domain`],
    answer: 2,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Because the function is not continuous`, `Because the function approaches 0 as x approaches infinity but never reaches it`, `Because the domain is not compact`, `Because the function has multiple local minima`],
    answer: 1,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`A convex objective function and convex constraints`, `A continuous objective function and a compact domain`, `A differentiable objective function with bounded derivatives`, `A coercive objective function with no constraints`],
    answer: 1,
    intuition: ``,
    ...
    code: ``,
    images: ["image_1777604639814_0.png", "lec22_slide_15.png"],
    tags: [],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`The function is bounded from below`, `The function approaches infinity as variables get farther from the origin`, `The function has unique minima`, `The function is continuously differentiable`],
    answer: 1,
    intuition: ``,
...
e(x) is not because its not going to positive infinity.`,
    code: ``,
    images: ["image_1777604881232_0.png", "lec22_slide_15.png"],
    tags: [],
    source: `lectures/cg-22-lecture-quiz.md`,
  },
  {
    ...
    options: [`Whether a function is convex`, `Whether a point is a local minimum`, `Whether a point is a global minimum`, `Whether a function is coercive`],
    answer: 2,
    intuition: ``,
