...
// Lecture 22: Introduction to Optimization — Part 3 · QQ62–QQ62 · 1 questions (1 MCQ, 0 reveal)
...
export default function Lec22Part3Quiz() {
    ...
    <div style={base}>
      <div style={box}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '2.2rem', fontWeight: 700, color: C.accent, margin: '0 0 0.5rem' }}>Lecture 22: Introduction to Optimization — Part 3</h1>
          ...
          <a key={3} href={`${BASE}/lec22/3`} style={{ color: C.accent, fontSize: "0.85rem" }}>Part 3</a>
          </div>
          <p style={{ color: C.accent, fontWeight: 600 }}>QQ62–QQ62 · 1 questions (1 graded + 0 open)</p>
        </div>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{ color: C.accent, fontWeight: 600 }}>Lecture 22: Introduction to Optimization — Part 3</span>
            </div>
