...
const quizData = [
  ...
  },
  {
    ...
    options: [`∂x₁/∂x₁ + ∂x₂/∂x₂`, `The divergence of the 2D vector field`, `The determinant of the 2×2 Jacobian matrix`, `∂x₂/∂x₁ - ∂x₁/∂x₂`],
    answer: 3,
    answerText: ``,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`The divergence of X equals the curl of the 90° rotation of X`, `They are completely independent operations`, `The curl is always perpendicular to the divergence`, `The sum of curl and divergence always equals zero`],
    answer: 0,
    answerText: ``,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`Changing from Eulerian to Lagrangian coordinates`, `Changing from laminar to turbulent flow`, `Changing from velocity field to stream function`, `Changing from 2D to 3D simulation`],
    answer: 2,
    answerText: ``,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`It only appears in specialized applications`, `It appears across many domains including geometry, rendering, simulation, and imaging`, `It's only useful for physics simulations`, `It's only important for color processing`],
    answer: 1,
    answerText: ``,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`As the gradient of the divergence`, `As the curl of the gradient`, `As the divergence of the curl`, `As the divergence of the gradient`],
    answer: 3,
    answerText: ``,
    intuition: ``,
  ...
  },
  {
    ...
    options: [`The Hessian is the determinant of the gradient`, `The Hessian is the integral of the gradient`, `The Hessian is the transpose of the gradient`, `The Hessian gives the directional derivative of the gradient`],
    answer: 3,
    answerText: ``,
    intuition: ``,
