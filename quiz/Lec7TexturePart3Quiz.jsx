...
// Lecture 7: Texture Mapping — Part 3 · QQ65–QQ85 · 21 questions (21 MCQ, 0 reveal)
    ...
    <div style={base}>
      <div style={box}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: C.accent, fontWeight: 600 }}>QQ65–QQ85 · 21 questions (21 graded + 0 open)</p>
        </div>
