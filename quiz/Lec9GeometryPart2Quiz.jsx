...
// Lecture 9: Introduction to Geometry — Part 2 · QQ33–QQ37 · 5 questions (5 MCQ, 0 reveal)
...
const quizData = [
  {
    ...
    format: `mcq`,
    timestamp: `55:17`,
    question: `What are the two main continuity requirements when connecting Bézier curve segments?`,
    options: [`Position continuity and tangent continuity`, `Tangent continuity and normal continuity`, `Position continuity and curvature continuity`, `G¹ continuity and G² continuity`],
    answer: 0,
    answerText: ``,
    intuition: ``,
    explanation: `At [55:41], the lecturer explains: "For one thing the endpoints of one piece of the curve have to agree with the endpoints of the next piece of the curve otherwise we'll just get a gap, we'll get a discontinuity. Even if the endpoints agree we can get these kind of sharp kinks in the curve if we don't think carefully about how the tangents look."`,
    code: ``,
  ...
  },
  {
    ...
    format: `mcq`,
    timestamp: `1:00:08`,
    question: `What is a tensor product in the context of Bézier patches?`,
    options: [`A product of a curve function f(u) and a curve function g(v)`, `A type of gradient descent`, `A multiplication of two matrices`, `A form of vector calculus`],
    answer: 0,
    answerText: ``,
    intuition: ``,
    explanation: `At [1:00:46], the lecturer defines: "So at any point uv the value of my function is just f of u times g of v. This is called a tensor product, very fancy name for a very very simple idea."`,
    code: ``,
    images: ["lec9_slide_70.png"],
    tags: [],
    source: `lectures/cg-09-lecture-quiz.md`,
  },
  {
    ...
    format: `mcq`,
    timestamp: `1:03:15`,
    question: `What is the key challenge in achieving tangent continuity with Bézier patches?`,
    options: [`It requires special hardware`, `Irregular patch layouts make it difficult`, `It's impossible for non-quadrilateral patches`, `The mathematics is more complex than with curves`],
    answer: 1,
    answerText: ``,
    intuition: ``,
    explanation: `At [1:04:30], the lecturer explains: "If you do this, if you have this nice regular layout of patches, then the degree of freedom counting works out. You can get good tangent continuity... Unfortunately this is too constrained in practice to make interesting shapes with good continuity. You really need to allow patches with more interesting connectivity."`,
    code: ``,
    images: ["lec9_slide_70.png"],
    tags: [],
    source: `lectures/cg-09-lecture-quiz.md`,
  },
  {
    ...
    format: `mcq`,
    timestamp: `1:05:59`,
    question: `How does NURBS overcome the limitation that Bézier curves cannot exactly represent conics?`,
    options: [`By approximating conics with many small curve segments`, `By using higher-degree Bernstein polynomials`, `By using homogeneous coordinates and rational functions`, `By using subdivision instead of polynomials`],
    answer: 2,
    answerText: ``,
    intuition: ``,
    explanation: `At [1:06:35], the lecturer explains: "The solution amazingly enough is to once again use homogeneous coordinates. So what you can do is do the same kind of interpolation, same interpolation by bernstein polynomials in homogeneous coordinates, and then do a projection back to the plane to get what's called a rational b spline."`,
    code: ``,
    images: ["lec9_slide_70.png"],
    tags: [],
    source: `lectures/cg-09-lecture-quiz.md`,
  },
  {
    ...
    format: `mcq`,
    timestamp: `1:09:00`,
    question: `What is the basic process of subdivision for curves?`,
    options: [`Adding more control points to an existing curve`, `Using boolean operations to build curves`, `Converting between explicit and implicit representations`, `Splitting each edge and then taking weighted averages of neighboring vertices`],
    answer: 3,
    answerText: ``,
    intuition: ``,
    explanation: `At [1:09:17], the lecturer describes: "For curves you could imagine you start with a control curve or control polygon and then you repeatedly well you subdivide you split each edge of the polygon into two let's say and then you take some weighted average of the neighboring vertices to get the new vertex positions."
-
-`,
    code: ``,
    images: ["lec9_slide_70.png"],
...
export default function Lec9Part2Quiz() {
    ...
    <div style={base}>
      <div style={box}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '2.2rem', fontWeight: 700, color: C.accent, margin: '0 0 0.5rem' }}>Lecture 9: Introduction to Geometry — Part 2</h1>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', marginBottom: '0.5rem' }}>
            <a key={1} href={`${BASE}/lec9/1`} style={{ color: C.muted, fontSize: "0.85rem" }}>Part 1</a>
          <a key={2} href={`${BASE}/lec9/2`} style={{ color: C.accent, fontSize: "0.85rem" }}>Part 2</a>
          </div>
          <p style={{ color: C.accent, fontWeight: 600 }}>QQ33–QQ37 · 5 questions (5 graded + 0 open)</p>
        </div>

        <div style={{ background: '#0d0d12', padding: '1.5rem', borderRadius: '12px', marginBottom: '2rem', border: `1px solid ${C.border}` }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1rem', textAlign: 'center' }}>
            <div><div style={{ fontSize: '2rem', fontWeight: 700, color: C.accent }}>5</div><div style={{ color: C.muted, fontSize: '0.9rem' }}>Graded MCQ</div></div>
    ...
    <div style={base}>
      <div style={box}>
        ...
        <div style={{ background: '#0d0d12', padding: '2rem', borderRadius: '12px', marginBottom: '2rem', textAlign: 'center', border: `1px solid ${C.border}` }}>
          ...
          <div style={{ fontSize: '1.2rem', color: C.muted, marginBottom: '0.75rem' }}>{score} / 5 MCQ correct</div>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{ color: C.accent, fontWeight: 600 }}>Lecture 9: Introduction to Geometry — Part 2</span>
            </div>
          ...
          <div style={{ height: '5px', background: C.border, borderRadius: '3px', overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${Math.round((qIdx+1)/5*100)}%`, background: C.accent, transition: 'width 0.3s' }} />
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          {(showExp || revealed || reviewMode) && (
            <button onClick={handleNext} style={btn({ flex:1, justifyContent:'center' })}>
              {qIdx < 5-1 ? 'Next Question' : 'View Results'} <ChevronRight size={20} />
            </button>
          )}
        </div>
      </div>
